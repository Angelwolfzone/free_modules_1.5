...
{elseif $status == 'pending'}
	...
	<p>{l s='For any questions or for further information, please contact our' mod='masterpayment'} <a href="{$link->getPageLink('contact-form.php', true)}">{l s='customer support' mod='masterpayment'}</a></p>
{else}
	<p class="warning">
